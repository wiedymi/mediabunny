"use strict";var Metamuxer=(()=>{var ht=Object.defineProperty;var gr=Object.getOwnPropertyDescriptor;var Tr=Object.getOwnPropertyNames;var xr=Object.prototype.hasOwnProperty;var Cr=(i,e)=>{for(var t in e)ht(i,t,{get:e[t],enumerable:!0})},Sr=(i,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Tr(e))!xr.call(i,s)&&s!==t&&ht(i,s,{get:()=>e[s],enumerable:!(r=gr(e,s))||r.enumerable});return i};var wr=i=>Sr(ht({},"__esModule",{value:!0}),i);var Vi={};Cr(Vi,{ALL_FORMATS:()=>br,AUDIO_CODECS:()=>J,ArrayBufferSource:()=>tt,ArrayBufferTarget:()=>ce,AudioBufferDrain:()=>ft,AudioBufferSource:()=>Ye,AudioDataDrain:()=>Re,AudioDataSource:()=>Ge,AudioSource:()=>U,BlobSource:()=>rt,CanvasSource:()=>je,EncodedAudioChunkDrain:()=>Ae,EncodedAudioChunkSource:()=>Xe,EncodedVideoChunkDrain:()=>Ie,EncodedVideoChunkSource:()=>$e,ISOBMFF:()=>ve,Input:()=>ut,MATROSKA:()=>ct,MKV:()=>Ft,MOV:()=>pr,MP4:()=>fr,MediaSource:()=>te,MediaStreamAudioTrackSource:()=>Ze,MediaStreamVideoTrackSource:()=>qe,MkvOutputFormat:()=>xe,Mp4OutputFormat:()=>Ke,Output:()=>et,OutputFormat:()=>L,SUBTITLE_CODECS:()=>ke,Source:()=>me,StreamTarget:()=>Ue,SubtitleSource:()=>re,Target:()=>H,TextSubtitleSource:()=>Je,VIDEO_CODECS:()=>Z,VideoFrameDrain:()=>lt,VideoFrameSource:()=>Qe,VideoSource:()=>z,WEBM:()=>hr,WebMOutputFormat:()=>ee});function d(i){if(!i)throw new Error("Assertion failed.")}var A=i=>i&&i[i.length-1],$=i=>i>=0&&i<2**32,R=(i,e,t)=>{let r=0;for(let s=e;s<t;s++){let n=Math.floor(s/8),a=i[n],c=7-(s&7),o=(a&1<<c)>>c;r<<=1,r|=o}return r},Mt=(i,e,t,r)=>{for(let s=e;s<t;s++){let n=Math.floor(s/8),a=i[n],c=7-(s&7);a&=~(1<<c),a|=(r&1<<t-s-1)>>t-s-1<<c,i[n]=a}},Q=i=>i instanceof ArrayBuffer?new Uint8Array(i):new Uint8Array(i.buffer,i.byteOffset,i.byteLength),M=new TextEncoder,bt=i=>Object.fromEntries(Object.entries(i).map(([e,t])=>[t,e])),j={bt709:1,bt470bg:5,smpte170m:6},Vt=bt(j),q={bt709:1,smpte170m:6,"iec61966-2-1":13},Pt=bt(q),X={rgb:0,bt709:1,bt470bg:5,smpte170m:6},Dt=bt(X),_e=i=>!!i&&!!i.primaries&&!!i.transfer&&!!i.matrix&&i.fullRange!==void 0,kt=i=>i instanceof ArrayBuffer||typeof SharedArrayBuffer<"u"&&i instanceof SharedArrayBuffer||ArrayBuffer.isView(i)&&!(i instanceof DataView),N=class{currentPromise=Promise.resolve();async acquire(){let e,t=new Promise(s=>{e=s}),r=this.currentPromise;return this.currentPromise=t,await r,e}},W=i=>{let e=i*(Math.PI/180),t=Math.cos(e),r=Math.sin(e);return[t,r,0,-r,t,0,0,0,1]},gt=W(0),zt=i=>[...i].map(e=>e.toString(16).padStart(2,"0")).join(""),Ut=i=>(i=i>>1&1431655765|(i&1431655765)<<1,i=i>>2&858993459|(i&858993459)<<2,i=i>>4&252645135|(i&252645135)<<4,i=i>>8&16711935|(i&16711935)<<8,i=i>>16&65535|(i&65535)<<16,i>>>0),B=(i,e,t)=>{let r=0,s=i.length-1,n=-1;for(;r<=s;){let a=r+s>>1,c=t(i[a]);c===e?(n=a,s=a-1):c<e?r=a+1:s=a-1}return n},I=(i,e,t)=>{let r=-1,s=0,n=i.length-1;for(;s<=n;){let a=s+(n-s+1)/2|0;t(i[a])<=e?(r=a,s=a+1):n=a-1}return r},G=()=>{let i,e;return{promise:new Promise((r,s)=>{i=r,e=s}),resolve:i,reject:e}},Bt=(i,e)=>{let t=i.indexOf(e);t!==-1&&i.splice(t,1)};var fe=/(?:(.+?)\n)?((?:\d{2}:)?\d{2}:\d{2}.\d{3})\s+-->\s+((?:\d{2}:)?\d{2}:\d{2}.\d{3})/g,yr=/^WEBVTT(.|\n)*?\n{2}/,ne=/<(?:(\d{2}):)?(\d{2}):(\d{2}).(\d{3})>/g,Ee=class{options;preambleText=null;preambleEmitted=!1;constructor(e){this.options=e}parse(e){e=e.replaceAll(`\r
`,`
`).replaceAll("\r",`
